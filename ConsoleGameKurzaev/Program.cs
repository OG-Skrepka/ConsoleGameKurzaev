...
namespace ConsoleGameKurzaev
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            int gold = 50;
            int arrows = 20;
            List<string> inventory = new List<string>() { "Мечь", "Стрелы" }; // Initial inventory
            ...
            bool gameEnded = false; // Flag to determine if the game has ended
            ...
            for (int roomNumber = 0; roomNumber < dungeonMap.Length; roomNumber++)
            {
                ...
                switch (currentRoom)
                {
                    ...
                    case "Chest":
                        ...
                        break;
                    case "Trader":
                        gold = MeetTrader(gold, health, inventory); // Pass inventory
                        break;
                    case "Empty Room":
            ...
            if (gameEnded)
            {
                ...
                Console.ReadKey(); // Await keystroke
            }
        }
        ...
        static string[] GenerateDungeonMap()
        {
            ...
            dungeonMap[9] = "Boss"; // Boss is always at the end
            return dungeonMap;
        }
        ...
        {
            Random rnd = new Random();
            int monsterHealth = rnd.Next(25, 61); // Monster is stronger
        ...
        static (List<string>, int, int) FindChest(List<string> inventory, int gold, int arrows)
        {
            ...
            int operation = rnd.Next(1, 4); // 1 - сложение, 2 - вычитание, 3 - умножение
            int correctAnswer = 0;
        ...
        static int MeetTrader(int gold, int health, List<string> inventory) // inventory is passed
        {
